...
* @returns {Map<any, any>}
*/
export function arrange_initial_witness(abi_json_str, inputs_json_str) {
...
* @returns {Map<any, any>}
*/
export function arrange_public_witness(abi_json_str, inputs_json_str) {
    const ptr0 = passStringToWasm0(abi_json_str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(inputs_json_str, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
...
* @returns {string}
*/
export function select_return_value(abi_json_str, intermediate_witness) {
    try {
...
* @returns {Map<any, any>}
*/
export function select_public_witness(circuit, intermediate_witness) {
...
function getImports() {
    ...
    imports.wbg.__wbg_keys_780cff79279a9bb1 = function(arg0) {
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('noir_util_wasm_bg.wasm', import.meta.url);
    }
    const imports = getImports();
